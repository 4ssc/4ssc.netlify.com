...
const Skill = () => {
  return (
    <Layout>
      ...
      <div className="grid mt-4 p-4 grid-cols-3 grid-rows-3 gap-2 items-center">
      ...
      <div className="grid p-4 grid-cols-3 grid-rows-3 gap-2 items-center">
        <div className=" row-span-3">
          <div className="image-size-95">
      ...
      <div className="grid p-4 grid-cols-3 grid-rows-3 gap-2 items-center">
        ...
        <div className="col-span-2">
          <h3 className="text-2xl">GatsbyJS</h3>
        </div>
        <div className="col-span-2 row-span-2">
