...
const Work = () => {
  return (
    <Layout>
      ...
      <div className="grid mt-4 p-4 grid-cols-3 grid-rows-4 gap-2 items-center">
        ...
        <div className="col-span-2">
          <h3 className="text-2xl">asai's-Portfolio</h3>
        </div>
        <div className="col-span-2">
          <Link to="/" className="hover:underline">https://</Link>
        </div>
        <div className="col-span-2 row-span-2">
          <p>JavaScriptのライブラリであるReactがベースとなっている、GatsbyJSというフレームワークを利用して、ほぼ無編集のスターターを使用しサイトを制作しました。</p>
        </div>
      </div>
      <div className="grid p-4 bg-gray-200 rounded-lg grid-cols-3 grid-rows-3 gap-2 items-center">
        <div className=" row-span-4">
          <div className="image-size-170">
        ...
        <div className="col-span-2">
          <h3 className="text-2xl">あさいてむ</h3>
        </div>
        <div className="col-span-2">
      ...
      <div className="grid mt-4 p-4 grid-cols-3 grid-rows-4 gap-2 items-center">
        ...
        <div className="col-span-2">
          <h3 className="text-2xl">一級建築士事務所 ビオス</h3>
        </div>
        <div className="col-span-2">
